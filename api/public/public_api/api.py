...
from .endpoints.wake_word_sample import WakeWordSampleUpload
...
public.add_url_rule(
    "/v1/device/<string:device_id>/wake-word-sample",
    view_func=WakeWordSampleUpload.as_view("wake_word_sample"),
    methods=["POST"],
)
